...
class StoreController {
    ...
    async delete(req: FastifyRequest, res: FastifyReply) {
        ...
        try {
            ...
            res.status(200).send({ message: 'Estabelecimento deletado com sucesso!', store: result.rows[0] });
        } catch (error: any) {
            res.status(500).send({ message: 'Erro ao deletar estabelecimento.', error: error.message });
        } finally {
            client.release();
        }
    }
    ...
    async update(req: FastifyRequest, res: FastifyReply) {
        ...
        try {
            ...
            res.status(200).send({ message: 'Estabelecimento atualizado com sucesso!', store: result.rows[0] });
        } catch (error: any) {
            res.status(500).send({ message: 'Erro ao atualizar estabelecimento.', error: error.message });
        } finally {
            client.release();
        }
    }
    ...
    async getByName(req: FastifyRequest, res: FastifyReply) {
        ...
        try {
            ...
            res.status(500).send({ message: 'Erro ao buscar estabelecimento.', error: error.message });
        } finally {
            client.release();
        }
    }
